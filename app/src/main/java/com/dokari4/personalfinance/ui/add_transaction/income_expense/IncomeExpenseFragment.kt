package com.dokari4.personalfinance.ui.add_transaction.income_expense
...
import com.dokari4.personalfinance.ui.add_transaction.AccountAdapter
import com.dokari4.personalfinance.ui.add_transaction.AddTransactionViewModel
...
class IncomeExpenseFragment : Fragment() {
    ...
    private fun setValueFromViewModel() {
        ...
        accountAdapter.setPosition(viewModel.accountIdStart.value)
    }
